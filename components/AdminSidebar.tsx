          ...
          >
            ...
            {selectedSubMenu2 === true && (
              <ul className={styles['sub-menu']} onClick={(e) => e.stopPropagation()}>
                ...
                <Link href="/admin/backend/tournament/newregis?status=0" className={styles.link} ><li className={`${styles['sub-menu-item']} ${ router.pathname === '/admin/backend/tournament/newregis' ? styles.activeSubMenu : ''}`}> <div><FaHandPointRight /> <span>อนุมัติ/สลิป</span></div></li></Link>
