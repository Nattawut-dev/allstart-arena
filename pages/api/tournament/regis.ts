        ...
        form.parse(req, async (err, fields, files) => {
            ...
            try {
                ...
                if (imageUrl1 && imageUrl2) {
                  try {
                    const insertQuery = `
                      INSERT INTO tournament (id,listT_id, team_name, Name_1, Nickname_1, age_1, gender_1, affiliation_1, tel_1, image_1, Name_2, Nickname_2, age_2, gender_2, affiliation_2, tel_2, image_2, level) 
                      VALUES (null,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                    `;
