...
// export const getServerSideProps: GetServerSideProps<Props2> = async () => {
//     try {
//         const Listtournament = await fetch(`${process.env.HOSTNAME}/api/tournament/listtournament`);
//         const Listtournament_data = await Listtournament.json();
//         console.log(Listtournament_data.results)
//         return {
//             props: {
//                 listtournament: Listtournament_data.results,
//             },
//         };
//     } catch (error) {
