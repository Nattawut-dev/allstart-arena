...
const ShuttleCockControlNewBie = ({ buffetId, shuttlecockTypeId, initialQty, onUpdated, readonly = false }: ShuttleCockControlProps) => {
    ...
    const updateShuttlecockQty = async (id: number, typeId: number, qty: number) => {
        try {
            await fetch('/api/admin/buffet/newbie/add_reduce', {
                method: 'PUT',
...
export default ShuttleCockControlNewBie;